...
//                dbDelta( $sql );
        ...
        {
            if ($dbVersion < 1.0) {
                if ($dbVersion==EEWEE_VERSION) {
                    return EEWEE_VERSION;
                }
                $this->upgrade_1_0();
                $dbVersion=1.0;
            }
        ...
        public function upgrade_1_0()
        {
            global $wpdb;
            $this->updateVersion("1.0");
        }

        public function upgrade_1_1()
        {
            global $wpdb;
            $this->updateVersion("1.1");
        }

        public function upgrade_1_11()
        {
            global $wpdb;
